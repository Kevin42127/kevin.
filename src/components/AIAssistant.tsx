                    ...
                    {message.role === 'assistant' ? (() => {
                      const formatText = (text: string) => {
                        ...
                        formatted = formatted.replace(/\[DOWNLOAD_RESUME_ZH\]/g, 
                          '<a href="/陳梓敬_AI工程師_履歷.pdf" download="陳梓敬_AI工程師_履歷.pdf" class="inline-flex items-center justify-center download-btn-custom" style="border: 2px solid rgb(168, 38, 255); background-color: white; width: 50px; height: 50px; border-radius: 10px; position: relative; z-index: 1; transition: all 0.2s ease; cursor: pointer; text-decoration: none;" title="' + (currentLanguage === 'en' ? 'Download Resume' : '下載履歷') + '" onmouseover="this.style.backgroundColor=\'rgb(168, 38, 255)\'; this.querySelector(\'span\').style.color=\'white\';" onmouseout="this.style.backgroundColor=\'white\'; this.querySelector(\'span\').style.color=\'rgb(168, 38, 255)\';"><span class="material-symbols-outlined" style="font-size: 25px; color: rgb(168, 38, 255); transition: all 0.3s ease;">download</span></a>')
                        
                        formatted = formatted.replace(/\[VIEW_PORTFOLIO\]/g, 
                          '<button onclick="document.getElementById(\'portfolio\')?.scrollIntoView({behavior: \'smooth\'})" class="inline-flex items-center justify-center download-btn-custom" style="border: 2px solid rgb(168, 38, 255); background-color: white; width: 50px; height: 50px; border-radius: 10px; position: relative; z-index: 1; transition: all 0.2s ease; cursor: pointer;" title="' + (currentLanguage === 'en' ? 'View Portfolio' : '查看作品集') + '" onmouseover="this.style.backgroundColor=\'rgb(168, 38, 255)\'; this.querySelector(\'span\').style.color=\'white\';" onmouseout="this.style.backgroundColor=\'white\'; this.querySelector(\'span\').style.color=\'rgb(168, 38, 255)\';"><span class="material-symbols-outlined" style="font-size: 25px; color: rgb(168, 38, 255); transition: all 0.3s ease;">work</span></button>')
                        
                        formatted = formatted.replace(/\[CONTACT_FORM\]/g, 
                          '<button onclick="document.getElementById(\'contact\')?.scrollIntoView({behavior: \'smooth\'})" class="inline-flex items-center justify-center download-btn-custom" style="border: 2px solid rgb(168, 38, 255); background-color: white; width: 50px; height: 50px; border-radius: 10px; position: relative; z-index: 1; transition: all 0.2s ease; cursor: pointer;" title="' + (currentLanguage === 'en' ? 'Contact Form' : '聯繫表單') + '" onmouseover="this.style.backgroundColor=\'rgb(168, 38, 255)\'; this.querySelector(\'span\').style.color=\'white\';" onmouseout="this.style.backgroundColor=\'white\'; this.querySelector(\'span\').style.color=\'rgb(168, 38, 255)\';"><span class="material-symbols-outlined" style="font-size: 25px; color: rgb(168, 38, 255); transition: all 0.3s ease;">mail</span></button>')
