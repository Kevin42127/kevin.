                    ...
                    {message.role === 'assistant' ? (() => {
                      const formatText = (text: string) => {
                        ...
                        formatted = formatted.replace(/\[DOWNLOAD_RESUME_ZH\]/g, 
                          '<a href="/陳梓敬_AI工程師_履歷.pdf" download="陳梓敬_AI工程師_履歷.pdf" style="color: var(--color-primary); text-decoration: underline; transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.opacity=\'0.7\';" onmouseout="this.style.opacity=\'1\';">' + (currentLanguage === 'en' ? 'Download Resume' : '下載履歷') + '</a>')
