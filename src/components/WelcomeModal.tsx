        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 min-h-0">
            ...
            >
              ...
              <div className="bg-[var(--color-chip)] text-[rgb(var(--foreground-rgb))] border border-[var(--color-divider)] rounded-2xl px-3 py-2.5 max-w-[70%]" style={{ lineHeight: 1.35, fontSize: '15px' }}>
