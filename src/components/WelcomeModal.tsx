      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 min-h-0">
            <motion.div
              className="flex items-end justify-end gap-1.5 sm:gap-2"
              initial="hidden"
              animate="visible"
              variants={messageVariants}
              transition={{ delay: 0, duration: MESSAGE_DURATION, ease: [0.16, 1, 0.3, 1] }}
            >
              <div className="inline-block max-w-[70%] px-3 py-2.5 bg-[var(--ai-accent)] text-white rounded-2xl" style={{ lineHeight: 1.35, fontSize: '15px' }}>
            ...
            >
              ...
              <div className="bg-[var(--color-surface-variant)] text-[rgb(var(--foreground-rgb))] border border-[var(--color-divider)] rounded-2xl px-3 py-2.5 max-w-[70%]" style={{ lineHeight: 1.35, fontSize: '15px' }}>
